...
public static class ColorGradeFile
{
    ...
    private sealed class QualifierPayload
    {
        public bool Enabled;
        public bool Invert;
        public float HueCenter = PostProcessLook.Qualifier.HueCenter;
        public float HueWidth = PostProcessLook.Qualifier.HueWidth;
        public float HueSoftness = PostProcessLook.Qualifier.HueSoftness;
        public float SaturationCenter = PostProcessLook.Qualifier.SaturationCenter;
        public float SaturationWidth = PostProcessLook.Qualifier.SaturationWidth;
        public float SaturationSoftness = PostProcessLook.Qualifier.SaturationSoftness;
        public float LuminanceCenter = PostProcessLook.Qualifier.LuminanceCenter;
        public float LuminanceWidth = PostProcessLook.Qualifier.LuminanceWidth;
        public float LuminanceSoftness = PostProcessLook.Qualifier.LuminanceSoftness;
        public float HueShift = PostProcessLook.ColorGrading.Hue;
        ...
        public float Temperature = PostProcessLook.Grade.Temperature;
        public float Tint = PostProcessLook.Grade.Tint;
        public Vector3 Lift = PostProcessLook.Grade.PrimaryLift;
        public Vector3 Gamma = PostProcessLook.Grade.PrimaryGamma;
        public Vector3 Gain = PostProcessLook.Grade.PrimaryGain;
    ...
    {
        public int Version;
        public int Transform = (int)PostProcessLook.Grade.Transform;
        public float Exposure = PostProcessLook.ColorGrading.Exposure;
        public float Contrast = PostProcessLook.ColorGrading.Contrast;
        public float Pivot = PostProcessLook.ColorGrading.ContrastPivot;
        public float Shadows = PostProcessLook.ColorGrading.TonalAdjustment;
        public float Highlights = PostProcessLook.ColorGrading.TonalAdjustment;
        public float Blacks = PostProcessLook.ColorGrading.TonalAdjustment;
        public float Whites = PostProcessLook.ColorGrading.TonalAdjustment;
        public float Toe = PostProcessLook.ColorGrading.TonalAdjustment;
        public float Shoulder = PostProcessLook.ColorGrading.TonalAdjustment;
        public float Saturation = PostProcessLook.ColorGrading.Saturation;
        public float CdlSaturation = PostProcessLook.ColorGrading.CdlSaturation;
        public float Vibrance = PostProcessLook.ColorGrading.Vibrance;
        public float Hue = PostProcessLook.ColorGrading.Hue;
        public float Temperature = PostProcessLook.Grade.Temperature;
        public float Tint = PostProcessLook.Grade.Tint;
        public Vector3 Slope = PostProcessLook.Grade.Slope;
        public Vector3 Offset = PostProcessLook.Grade.Offset;
        public Vector3 Power = PostProcessLook.Grade.Power;
        public Vector3 PrimaryLift = PostProcessLook.Grade.PrimaryLift;
        public Vector3 PrimaryGamma = PostProcessLook.Grade.PrimaryGamma;
        public Vector3 PrimaryGain = PostProcessLook.Grade.PrimaryGain;
        public Vector3 PrimaryOffset = PostProcessLook.Grade.PrimaryOffset;
        public Vector4 PrimaryMaster = PostProcessLook.Grade.PrimaryMaster;
        public Vector3 CdlMaster = PostProcessLook.ColorGrading.CdlMaster;
        public float WhitePoint = PostProcessLook.Grade.WhitePoint;
