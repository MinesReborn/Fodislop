...
public sealed class FrameBreakdownWindow : ToolWindow
{
    ...
    private readonly List<ToolWindow> _toolWindowRows = [];
    ...
    private void RebuildRows()
    {
        ...
        switch (_tab)
        {
            ...
            case Tab.Tools: FrameBreakdownRowBuilder.BuildToolRows(rows, _toolWindowRows, _interface, _search); break;
    ...
    private void RebuildAllRows()
    {
        ...
        FrameBreakdownRowBuilder.BuildToolRows(_rows[Tab.Tools], _toolWindowRows, _interface, _search);
