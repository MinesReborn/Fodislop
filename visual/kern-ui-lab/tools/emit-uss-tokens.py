...
WARNING = ("/* ФАЙЛ МАШИННЫЙ. Правки будут затёрты.\n"
           "   Источник истины: visual/kern-ui-lab/css/tokens.css\n"
           "   Генератор:       visual/kern-ui-lab/tools/emit-uss-tokens.py\n"
...
def emit_palette(base) -> str:
    ...
    return json.dumps({
        "_": "Машинный файл. Источник visual/kern-ui-lab/css/tokens.css, "
...
def main() -> int:
    ...
    if args.check:
        if stale:
            ...
            print("\n  Источник истины — visual/kern-ui-lab/css/tokens.css")
            print("  Выполните: python3 visual/kern-ui-lab/tools/emit-uss-tokens.py")
            return 1
